...
Delphi 共识识别的核心区分在于**成因、初始发生时间、以及特异性特征的底层机制**：

#### 青少年：孤独谱系 vs CPTSD

| 维度     | 孤独谱系                     | CPTSD                                   | 共识        |
| ------ | ------------------------ | --------------------------------------- | --------- |
| 发生     | 出生或幼儿期即显现（6-12 月可有迹象）    | 创伤事件后出现                                 | 96%       |
| 进展     | 终生性                      | 并非必然终生（取决于创伤对发育脑的影响、发育时机、创伤性质和对循证干预的应答） | 96%       |
...
| 维度     | 孤独谱系               | 依恋障碍                     | 共识  |
| ------ | ------------------ | ------------------------ | --- |
| 成因     | 神经发育性              | 5 岁前照护不足（忽视、多次更换照护者、机构化） | 80% |
...
1. **全面历史采集**（与个体、家长/照护者）——必须包括发育史和家族史（共识 94%–96%）
2. **特征初始发生相对于创伤事件的时间线**（CPTSD 鉴别必需）
3. **参考诊断标准**（DSM/ICD）
4. **状况特异性量表**：
...
- 信息不完整（知情人不可靠、发育史缺失、特征初始发生不清晰、语言障碍）
...
- [[PDA]] — 孤独谱系的特殊剖面，其要求回避行为可能与 EUPD 的人际策略混淆
