...
1. **非病症主张（Non-disorder claim）**：孤独谱系及其他神经殊异性状况并非病症，因为它们本质上并无害处——这是最核心的主张
...
### 2. 区分孤独谱系与共现状况（co-occurring conditions）
- 将有害表现归因于共现状况（如智力障碍、癫痫）而非孤独谱系本身
- 失败原因：孤独谱系与共现状况的因果关系复杂交织，无法清晰分离；许多被归因于共现状况的特征与孤独谱系因果相关
...
本文是[[神经多样性范式]]面临的最系统的哲学挑战之一，直接关联以下辩论：

- [[常态范式]] — 论文捍卫了病症概念对部分孤独谱系表现的适用性
...
- [[ChapmanFletcherWatson2026|Chapman & Fletcher-Watson (2026)]] — Chapman 在 VSI 中已预见到这一挑战（"所谓的更严重状况"被呈现为范式缺陷的证据）

## Related

### 相关概念
- [[神经多样性范式]] — 本文挑战的核心对象
- [[常态范式]] — Hughes 捍卫病症概念对部分孤独谱系表现的适用性
- [[神经多样性与学习障碍]] — 异质性挑战最集中涉及的群体
- [[庸俗版神经多样性]] — Hughes 批判不同于范式内部批判
- [[去病理化]] — XyZ 对去病理化复杂光谱的系统分析，回应异质性异议

### 相关文献
- [[ChapmanFletcherWatson2026|Chapman & Fletcher-Watson (2026)]] — Chapman 在 VSI 中预见到这一挑战
- [[Walker2014|Walker (2014)]] — Hughes 主要依赖 Walker 作为范式代表性阐述
