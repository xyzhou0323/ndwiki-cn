...
| 特征类别 | 涵盖内容 |
|----------|----------|
| 认知能力下降 | 思维/处理、决策、解决问题、记忆 |
| 情绪调节下降 | 冲动控制、情绪波动、易怒 |
| 感官敏感性增高 | 感官不耐受、过度刺激、崩溃/关闭、过滤困难 |
| 功能能力下降 | 社交/沟通、独立生活、职业/学业、排序与计划 |
| 回避与退缩增加 | 社交回避、环境回避、活动回避 |
| 耗竭增加 | 心理耗竭、身体耗竭 |

当前推荐的修订版为纳入 AASPIRE 成果项目（Outcomes Project）而修订。成果项目团队采用 CBPR 方法，旨在：1) 创建并验证 AASPIRE Measurement Toolkit；2) 了解哪些因素能预测结局随时间的改变（Nicolaidis et al., 2026a）。
...
AASPIRE Measurement Toolkit 中的每个工具均有自评和照护者报告版本。社区-学术团队合作修订了该工具，针对伴有或不伴有智力残障的孤独谱系成年人开发并测试，但也可用于一般人群。
...
每道题均以"至少在过去三个月里"为时间框架，要求受测者将当前体验与自身平常情况进行比较。

**Likert 量表：**

| 分值 | 标签 |
|------|------|
| 4 | 非常同意 (Strongly Agree) |
| 3 | 同意 (Agree) |
| 2 | 既不同意也不不同意 (Neither Agree nor Disagree) |
| 1 | 不同意 (Disagree) |
...
这些问题询问的是已经持续至少三个月的经历：

- 这些事情可能已经持续了 3 个月，也可能已经持续了多年
- 如果不记得确切持续了多久，也没关系
- 不必每一天都经历这些事情，也可以算持续三个月以上
- 但不要包括那些只持续了几天或几周的事情

#### 如何将经历与"对你而言的常态"进行比较？

这些问题要求将经历与对受测者而言的"常态"进行比较：

- "通常"指的是受测者认为对自己而言正常或最典型的情况，这可能与当前的体验相同，也可能不同
- 在这些方面的体验有较大波动是正常的——思考当前的波动与通常的波动之间是否存在差异
- 如果长时间感觉不好，请回想开始感觉不好之前的情况

#### 回答示例：不同的人如何回答

以下是三个示例，说明不同情况的人应如何作答：
...
以下项目包含在成果项目关于孤独谱系耗竭的调查部分中，**不计入总分**，仅供临床或研究参考。

**初始发生**（当症状条目中至少一项选"同意"或"非常同意"时显示）：

- **#15** 这些变化似乎是多久出现的？→ 数天/数周内迅速恶化 / 经过数月或数年的缓慢积累 / 其他
- **#16** 您认为是什么导致了这些变化？（多选）→ 身体疾病、手术或事故 / 重大生活事件或过渡期 / 期望与能力、资源和支持之间的长期不匹配 / 其他

**自我反思**：

- **#17** 在参与本次调查之前，您是否听说过"孤独谱系耗竭"？→ 是（了解）/ 是（不太了解）/ 否
- **#18** 您认为您曾经经历过孤独谱系耗竭吗？→ 是 / 否 / 我不知道
- **#19** 您认为您现在正在经历孤独谱系耗竭吗？→ 是 / 否 / 我不知道

**感知变化与参与支持**：

- 总体而言，在过去六个月中，本调查所询问的事情是变得更糟、保持不变还是变得更好？
- 您在回答本部分调查问题时是否获得了任何帮助？→ 是 / 否（如"是"，追问帮助类型）
...
初步分析支持该量表具有**单因子结构**（Nicolaidis et al., 2026a）。

| 维度 | 缩写 | 题数 | 分数范围 |
|------|------|------|----------|
| 孤独谱系耗竭 | ABS_Total | 14 | 0–56 |

## 心理测量学特性

原始版 AASPIRE 孤独谱系耗竭量表在 80 名孤独谱系成年人中进行了试点测试（49% 女性、31% 男性、20% 其他性别；年龄 18–68 岁，均值 35.9 岁）。内部一致性 α=0.95。建构效度经先验假设检验支持：与抑郁（CESD-10）的相关 r=.56（p<.0001），与感知压力（PSS-10）的相关 r=.68（p<.0001），当前自觉耗竭者的量表得分显著高于非耗竭者（p<.0001）。ROC 曲线 AUC=0.85，显示良好的分类能力。97% 的参与者认同研究团队对孤独谱系耗竭的定义。值得注意的是，掩饰行为（CAT-Q）与耗竭得分无显著相关（r=.04, p=.7）——研究团队推测 CAT-Q 测量的是掩饰行为的*执行*而非*压力*，且处于耗竭状态者可能更*难以*执行掩饰，因此横断面上无法捕捉二者的线性关系（[[RaymakerEtAl2026|Raymaker et al., 2026]]）。后续独立样本验证亦报告了良好的心理测量学特性（[[BougoureEtAl2025|Bougoure et al., 2025]]; [[MantzalasEtAl2024|Mantzalas et al., 2024]]）。

修订版正在作为 AASPIRE Outcomes Study 的一部分进行心理测量学测试，该研究是一项纵向队列研究，追踪约 850 名孤独谱系成年人的异质性样本随时间的变化（Nicolaidis et al., 2026a）。
...
关于该量表结构和结构效度的额外结果尚待发表，将在可用时在 AASPIRE Measurement Toolkit 网站上分享。
...
照护者报告版本与直接报告版本采用相同的 14 道症状条目结构，但措辞从第一人称改为第三人称（"they"）。附加项目中的自我反思题被替换为关于照护者信息来源的问题。

照护者报告版本同样包含：
- 症状严重程度（14 题，结构同自评版）
- 初始发生（#15–#16，判断方式同自评版）
- 关于感知变化及知识来源的标准照护者报告项目
- "超链接"中的辅助说明内容
...
| 维度 | 原始版 | 修订版 (AABS-R14) |
|------|--------|-----------------|
| 条目数 | 27 题（症状）+ 附加项目 | 14 题（症状）+ 附加项目 |
| 时间框架 | 未明确指定 | 明确为"至少在过去三个月里" |
| 比较基准 | 未明确 | 明确要求与"自身平常情况"比较 |
| 可及性 | 原始措辞 | 经认知访谈优化，提高可理解性 |
| 情景描述 | 无 | 每条附具体示例 |
| 初始发生 | 无 | 新增 2 题 |
| 自我反思 | 无 | 新增 3 题 |
| 结构效度 | 多因子 | 单因子（初步） |
...
1. [[Raymaker2020|Raymaker, D. M., Teo, A. R., Steckler, N. A., Lentz, B., Scharer, M., Delos Santos, A., Kapp, S. K., Hunter, M., Joyce, A., & Nicolaidis, C. (2020).]] "Having all of your internal resources exhausted beyond measure and being left with no clean-up crew": defining autistic burnout. *Autism in Adulthood*. DOI: [10.1089/aut.2019.0079](https://doi.org/10.1089/aut.2019.0079)
2. Nicolaidis, C., Moura, I., Baker-Ericzén, M., ... & Gardiner, F. (2026a). Addressing common problems in autism research: Cohort development and sample description for a participatory, real-world, longitudinal study of outcomes in autistic adults. *PsyArXiv*. [https://osf.io/preprints/psyarxiv/4m3bf](https://osf.io/preprints/psyarxiv/4m3bf)
3. Nicolaidis, C., Raymaker, D. M., Baker-Ericzén, M., ... & Flores, K. J. (2026b). Measuring high-priority outcomes in autistic adults: Initial psychometric assessment of the instruments in the AASPIRE Measurement Toolkit. *MedRxiv*. DOI: [10.64898/2026.03.23.26349108](https://doi.org/10.64898/2026.03.23.26349108)
4. Nicolaidis, C., Raymaker, D. M., Yang, L.Q., Kaufman, N., Uretsky, M., Joyce, A., Maslak, J., Wallington, A., & Frowner, E. (2025). Psychometric Characteristics of the AASPIRE Autistic Burnout Scale-Revised (AABS-R14). Poster presentation, International Society for Autism Research, Seattle, WA.
5. [[BougoureEtAl2025|Bougoure, M., Zhuang, S., Brett, J. D., Maybery, M. T., English, M. C., Tan, D. W., & Magiati, I. (2025).]] Measuring autistic burnout: A psychometric validation of the AASPIRE Autistic Burnout Measure in autistic adults. *Autism*, 13623613251355255.
6. [[MantzalasEtAl2024|Mantzalas, J., Richdale, A. L., Li, X., & Dissanayake, C. (2024).]] Measuring and validating autistic burnout. *Autism Research*, 17(7), 1417–1449.
7. Raymaker, D.M., Maslak, J., Steckler, N.A., Moura, I., Teo, A.R., Hunter, M., Yang, L.Q., Kapp, S., Scharer, M., & Nicolaidis, C. (2026). The AASPIRE Autistic Burnout Scale: Creation, pilot testing, and psychometric properties of a new measure of autistic burnout. PsyArXiv. DOI: [10.31234/osf.io/uqvtc_v1](https://doi.org/10.31234/osf.io/uqvtc_v1)

## 与神经多样性的关系

[[孤独谱系耗竭]]是[[神经多样性范式]]中的核心概念——它不是个体内在的缺陷，而是**个体能力、资源、支持与环境期望之间长期不匹配的结果**。AABS-R14 的设计体现这一视角：

- 量表要求与"自身平常情况"比较，而非与神经典型常态比较——尊重个体的神经多样性基线
- 附加项目 #16 将"期望与能力、资源和支持之间的长期不匹配"列为耗竭的可能原因之一
- 采用 CBPR 方法开发，孤独谱系社区成员全程参与
- 认知无障碍设计（情景描述、简化措辞）体现了神经多样性肯定实践

## Related

### 相关概念

- [[孤独谱系耗竭]] — AABS-R14 测量的核心构念
- [[孤独谱系障碍]] — 主要适用人群
- [[神经多样性范式]] — 量表设计的理论基础
- [[AASPIRE]] — 开发机构与成果项目
...
- [[Raymaker2020|Raymaker et al. (2020)]] — 孤独谱系耗竭的定义研究
- [[RaymakerEtAl2026|Raymaker et al. (2026)]] — ABM 原始版（27题）的创建与首次检验（N=80）
- [[MantzalasEtAl2024|Mantzalas et al. (2024)]] — ABM 的首篇公开发表心理测量验证（N=238）
- [[BougoureEtAl2025|Bougoure et al. (2025)]] — ABM 的大规模独立验证（N=379）
