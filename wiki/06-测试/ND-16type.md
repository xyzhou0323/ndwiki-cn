...
> [!infobox] ND-16type 神经多样性态度类型测试
> **测量对象**：个体对残障、支持与正义的深层态度
> **题数**：12 题（四个维度各 3 题）
> **开发者**：Dwyer (2022)、Srinivasan (2025)
...
**目标观 W — 福祉适应：** 认为干预的理由应是缓解痛苦或提升生活质量，而非为了让人看起来"正常"。支持保留无害的特征（如自我调节行为），认为这有助于个体调节。
...
ND-16type 在 NeuroXYZ 上被归类为"娱乐测试"。作为态度探索工具而非诊断工具，它更像是引导用户思考的**哲学对话触发器**。
...
- [[Dwyer2022]] — 互动主义的原始文献
- [[残障正义]] — 适用观 U（普遍正义）的理论来源："最受影响者的领导"原则
